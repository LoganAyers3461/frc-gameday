...
export interface paths {
    ...
    "/event/{event_key}/playoff_advancement": {
        ...
        get: operations["getEventPlayoffAdvancement"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        CmpQualificationMethod: "district_points" | "waitlist" | "original_and_sustaining" | "hall_of_fame" | "prior_year_cmp_winner" | "prior_year_cmp_impact" | "prior_year_cmp_engineering_inspiration" | "regional_winner" | "regional_impact" | "regional_engineering_inspiration" | "regional_wildcard" | "late_regional_winner" | "late_regional_impact" | "late_regional_engineering_inspiration" | "late_regional_wildcard" | "dcmp_winner" | "dcmp_impact" | "dcmp_engineering_inspiration" | "dcmp_rookie_all_star";
        District: {
        ...
        District_Advancement: {
            ...
            cmp_qualification?: components["schemas"]["CmpQualificationMethod"] | null;
        };
        ...
        District_Advancement_Cutoffs: {
            ...
            cmp_qualification: {
                [key: string]: components["schemas"]["CmpQualificationMethod"];
            };
        };
        ...
        District_Advancement_Response: {
            ...
            cutoffs: components["schemas"]["District_Advancement_Cutoffs"] | null;
        };
        District_Insight: {
            district_data: {
                region_data: {
        ...
        Media: components["schemas"]["Media_Avatar"] | components["schemas"]["Media_CdPhotoThread"] | components["schemas"]["Media_CdThread"] | components["schemas"]["Media_GrabCad"] | components["schemas"]["Media_NoDetails"] | components["schemas"]["Media_Onshape"] | components["schemas"]["Media_SmugmugAlbum"] | components["schemas"]["Media_SmugmugPhoto"];
        ...
        Media_Base: {
             ...
             * @enum {string}
             */
            type: "youtube" | "cdphotothread" | "imgur" | "facebook-profile" | "youtube-channel" | "twitter-profile" | "github-profile" | "instagram-profile" | "periscope-profile" | "gitlab-profile" | "grabcad" | "instagram-image" | "external-link" | "avatar" | "onshape" | "cd-thread" | "smugmug-photo" | "smugmug-album";
        ...
        Media_SmugmugAlbum: components["schemas"]["Media_Base"] & {
            /** @constant */
            type?: "smugmug-album";
            details?: {
                /** Format: uri */
        ...
        Media_SmugmugPhoto: components["schemas"]["Media_Base"] & {
            /** @constant */
            type?: "smugmug-photo";
            details?: {
                caption: string;
        ...
        InsightV2: components["schemas"]["InsightV2_Leaderboard"] | components["schemas"]["InsightV2_Streak"] | components["schemas"]["InsightV2_Timeseries"] | components["schemas"]["InsightV2_GameStats"] | components["schemas"]["InsightV2_Clubs"];
        InsightV2_Base: {
        ...
        InsightV2_GameStats: components["schemas"]["InsightV2_Base"] & components["schemas"]["InsightV2_GameStats_Extras"] & {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
        ...
        InsightV2_GameStats_Extras: {
            /** @constant */
            category?: "game_stats";
            data: components["schemas"]["InsightV2GameStatsData"];
        };
        InsightV2_Clubs: components["schemas"]["InsightV2_Base"] & components["schemas"]["InsightV2_Clubs_Extras"] & {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
        ...
        InsightV2_Clubs_Extras: {
            /** @constant */
            category?: "clubs";
            data: components["schemas"]["InsightV2ClubsData"];
        };
        ...
        InsightV2ClubsData: {
            ...
            entries: components["schemas"]["InsightV2ClubEntry"][];
            /**
        ...
        InsightV2ClubEntry: {
            ...
            extra_context?: components["schemas"]["InsightV2HallOfFameContext"];
        };
        ...
        InsightV2GameStatsData: {
            scopes: components["schemas"]["InsightV2GameStatsScope"][];
        };
        ...
        Playoff_Advancement: {
            ...
            rankings?: components["schemas"]["Playoff_Advancement_Alliance_Rank"][] | null;
            /** @description Describes each element of every ranking's `sort_orders` array, in order. */
            sort_order_info: components["schemas"]["Playoff_Advancement_Sort_Order_Info"][];
            /** @description Describes each element of every ranking's `extra_stats` array, in order. */
            extra_stats_info: components["schemas"]["Playoff_Advancement_Sort_Order_Info"][];
        };
    ...
    parameters: {
        ...
        insight_v2_category: "leaderboard" | "streak" | "timeseries" | "game_stats" | "clubs";
    ...
    getDistrictAdvancement: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["District_Advancement_Response"];
                };
            };
            304: components["responses"]["NotModified"];
            401: components["responses"]["Unauthorized"];
    ...
    getEventPlayoffAdvancement: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Playoff_Advancement"][];
                };
            };
            304: components["responses"]["NotModified"];
            401: components["responses"]["Unauthorized"];
